  ...
  return (
    <div className="mx-10 mt-24">
      <div className="flex w-full items-center gap-4">
        <div className="flex flex-col w-6/12 items-start justify-center space-y-4">
          ...
          <p className="text-5xl font-bold">Meet with Our Employees</p>
        ...
        {employee.map((item) => (
          <SwiperSlide key={item.id} className="">
              <div className="flex flex-col items-center justify-center space-y-4">
                 ...
                 <p className="text-stone-500">{item.name}</p>
