...
const Hero = () => {
    return (
        <div className='relative w-full' id='hero'>
          ...
          <div className='absolute inset-0 text-white lg:space-y-5 md:space-y-5 mt-10 text-center flex flex-col mx-auto items-center justify-center'>
             <p className='lg:text-3xl md:3xl font-sans uppercase font-bold pb-3'>  Grow Better, Harvest More<br />
...
Now shop online and get everything delivered straight to your doorstep.</p>
           ...
           <button style={{letterSpacing: ".5px"}}
            className='lg:px-10 md:px-10 px-3 lg:text-[17px] md:text-[17px] text-sm py-1 overflow-hidden  bg-amber-800 text-white rounded-md shadow-lg
