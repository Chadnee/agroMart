...
const About = () => {
  return (
   <div className="">
     <div className="flex mb-20 flex-col items-center mt-20 w-6/12 justify- mx-auto">
      <p className="pb-2 font-bold text-2xl font-serif">Overview</p>
      <span className="pb-20 italic font-thin text-sm text-[#3d6b08]">
        --“Trusted Products for Better Harvests”--
      </span>
      <div className="grid md:grid-cols-2 lg:grid-cols-2 grid-cols-1 gap-10 items-center justify-between">
        <figure>
        ...
        <div>
           ...
           <span className=" italic text-stone-600"> Our farm supply website is dedicated to providing high-quality seeds, fertilizers, tools, and other essentials that can helps farmer to grow stronger crops and a healthy farm as well as you want 
